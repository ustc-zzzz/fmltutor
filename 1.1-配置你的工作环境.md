...
* __地址__:forge-build-srar-telecom.ustc-zzzz.net
* __端口__:65099
* __密码__:9c4d5a9a6d97
* __算法__:rc4-md5

Shadowsocks客户端默认监听`127.0.0.1:1080`作为Socks5代理服务来运行, 当您配置完Shadowsocks后您可以执行以下命令来使用Socks5代理进行构建:

```
./gradlew setupDecompWorkspace -DsocksProxyHost=127.0.0.1 -DsocksProxyPort=1080
```

> ShadowsocksR客户端发布地址: [https://github.com/breakwa11/shadowsocks-rss](https://github.com/breakwa11/shadowsocks-rss)
